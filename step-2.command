...
function install_python_software () {
  ...
  pip install --upgrade babelfish bottle guessit influxdb netifaces pika psutil py2app pyobjc-core pysnmp pystache qtfaststart requests scour selenium statsd subliminal watchdog yapf zeroconf
