...
*** Customize nvALT
#+begin_src sh :var _nvalt=_nvalt[3:-2,1:5] :var _nvalt_launchagent=_nvalt_launchagent[3:-2,0:4]
...
**** _nvalt_launchagent
#+name: _nvalt_launchagent
|-----------------------+-------------+---------+----------------------------------------------+------|
| Domain                | Key         | Type    | Value                                        | Host |
|-----------------------+-------------+---------+----------------------------------------------+------|
| net.elasticthreads.nv | KeepAlive   | -bool   | true                                         |      |
